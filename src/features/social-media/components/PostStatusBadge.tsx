...
const STATUS_CONFIG: Record<PostStatus, { label: string; icon: React.ReactNode; classes: string }> = {
  PENDING: {
    label: 'Pending',
...
export function PostStatusBadge({ status, className = '', onClick }: PostStatusBadgeProps) {
