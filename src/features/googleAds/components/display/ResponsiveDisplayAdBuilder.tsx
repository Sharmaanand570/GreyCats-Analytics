...
interface ResponsiveDisplayAdBuilderProps {
  clientId: number;
  open: boolean;
...
export function ResponsiveDisplayAdBuilder({
  ...
  // @ts-expect-error unused variable
  adGroupId,
}: ResponsiveDisplayAdBuilderProps) {
  ...
  const handlePublish = (e: React.FormEvent) => {
    ...
    // Simulate API call for creating a Responsive Display Ad
    toast.success("Responsive Display Ad created successfully.");
    onOpenChange(false);
  };
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col p-0">
        <div className="px-6 py-4 border-b border-slate-200">
          <DialogTitle className="text-xl font-semibold">Responsive Display Ad</DialogTitle>
          <p className="text-sm text-slate-500 mt-1">
            Build ads that automatically adjust their size, appearance, and format to fit available ad spaces on the Google Display Network.
          </p>
        </div>
        ...
        <div className="flex-1 overflow-auto flex">
          ...
          <div className="flex-1 p-6 space-y-8">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input value={businessName} onChange={(e) => setBusinessName(e.target.value)} placeholder="e.g., GreyCats Analytics" />
                </div>
                <div className="space-y-2">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-medium text-slate-900 border-b pb-2 flex justify-between">
                Long Headline (1 required)
                {longHeadlines.length === 0 && <Button variant="ghost" size="sm" onClick={() => addField(longHeadlines, setLongHeadlines)} className="h-6 px-2 text-xs">Add</Button>}
              </h3>
          ...
          <div className="w-72 bg-slate-50 border-l border-slate-200 p-6 flex flex-col">
            ...
            <div className="space-y-3 flex-1">
              ...
              <ReqItem met={hasLongHeadline} label="1 Long Headline" />
