...
export const buildDefaultCoverSlide = (
  ...
  const textWidget: DashboardLayout = {
    ...
    data: {
      ...
      content: `# ${companyName ?? "Performance Report"}\n\n### Digital Marketing Overview\n\n---\n\n**Reporting Period:**  \n${subheading ?? "All Time"}\n\nThis report provides a comprehensive analysis of your multi-channel performance, highlighting key growth metrics, audience engagement, and strategic insights.\n\n**Generated by GreyCats Analytics**`,
      type: "text",
      align: "left",
      fontSize: "text-lg",
