...
const getIntegrationIcon = (integration?: string, metricKey?: string, label?: string) => {
  ...
  if (normKey.startsWith("google_seo.")) return <SiGooglesearchconsole className="text-blue-500" />;
  if (normKey.startsWith("google_ads.")) return <FaGoogle className="text-blue-500" />;
  if (normKey.startsWith("google.")) return <SiGoogleanalytics className="text-orange-500" />;
      ...
      >
        ...
        {isRefetching && (
          <div className="absolute top-1.5 right-1.5 z-10">
            <svg
              className="animate-spin h-3.5 w-3.5 text-gray-300"
