...
import { EmbedDisplayTab } from "./WidgetEditor/EmbedDisplayTab";
...
function EmbedWidgetForm({ id, data, onChange }: EmbedWidgetFormProps): React.JSX.Element {
  ...
  const handleChange = (updates: Partial<EmbedWidgetData>) => {
    setLocalData((prev) => ({ ...prev, ...updates } as EmbedWidgetData));
  };
